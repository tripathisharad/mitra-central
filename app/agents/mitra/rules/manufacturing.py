...
RULES = {
    "WIP_BY_WORK_ORDER": {
        ...
        "sql": (
            "SELECT wo.wo_nbr AS \"WO Number\", wo.wo_part AS \"Item\", "
            ...
            "FROM wo_mstr AS wo "
            "JOIN pt_mstr AS pt ON wo.wo_part = pt.pt_part AND wo.wo_domain = pt.pt_domain "
    ...
    "COMPONENT_SHORTAGE": {
        ...
        "sql": (
            "SELECT wod.wod_nbr AS \"WO Number\", wod.wod_lot AS \"Lot\", "
            ...
            "FROM wod_det AS wod "
            "JOIN pt_mstr AS pt ON wod.wod_part = pt.pt_part AND wod.wod_domain = pt.pt_domain "
